...
const carousel = async () => {
  ...
  try {
    ...
    // if (status === 400 && data.code === "TOKEN_MISSING") {
        ...
        <div id="MovieCarousel" class="carousel slide carousel-fade" >
            <ol class="carousel-indicators container">
                ${arrMovie
                  .map((_, index) => {
                    return `
                        <li data-target="#MovieCarousel" data-slide-to=${index} class=${
                      index === 0 ? "active" : ""
                    }></li>
                        `;
                  })
                   ...
                   <img src=${poster} class="carousel-img">
                    ...
                    <div class="container-md carousel-caption">
                        <div class="col-12 col-lg-9 p-0">
                            <p class="animate__animated animate__fadeInDown text-uppercase">${genres.join(
                              ", "
                            )}</p>
